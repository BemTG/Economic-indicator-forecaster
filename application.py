...
def GetForecast():
    ...
    plt.plot(df_forecast.head(months_out+1), label='Neural net model', linewidth=5)
    plt.plot(cli_df_full, label='Historical CLI values',linewidth=3)
    
    ax.axhline(y=100,color='gray')
    plt.legend(loc='best')
    plt.title('CLI forecast', fontsize=20)
...
def GetForecast2():
    ...
    plt.plot(df_forecast.head(months_out2+1), label='Neural net model', linewidth=5)
    plt.plot(bci_df_full, label='Historical BCI values', linewidth=3)
    
    ax2.axhline(y=100,color='gray')
    plt.legend(loc='best')
    plt.title('BCI forecast', fontsize=20)
...
def GetForecast3():
    ...
    plt.plot(df_forecast.head(months_out3+1), label='Neural net model', linewidth=5)
    plt.plot(cci_df_full, label='Historical CCI values', linewidth=3)
...
def GetForecast4():
    ...
    #plot the existing CLI and forcasted CLI values
    fig4,ax4 = plt.subplots(figsize=(16,10))
    plt.plot(df_forecast.head(months_out4+1), label='Neural net model', linewidth=5)
    plt.plot(df1['Close'], label='Historical SP500 values', linewidth=3)
